            ...
            <div className="space-y-6 py-6">
              ...
              <div className="pt-6 border-t border-purple-200">
                <Button
                  onClick={(e) => {
                    e.stopPropagation()
                    generateAIReport(selectedStaff)
                    setSelectedStaff(null) // Close detail modal
                  }}
                  className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white shadow-lg py-6 text-lg"
                  size="lg"
                >
