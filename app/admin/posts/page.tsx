...
import { PostCardAdmin } from "@/components/posts/post-card-admin"
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-emerald-400 to-cyan-400 mb-2">
                Social Feed
              </h1>
              <p className="text-slate-400">Manage and engage with your organization</p>
            </div>
            <button
              onClick={() => setShowCreateModal(true)}
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white font-medium rounded-xl shadow-lg shadow-blue-500/30 transition-all hover:scale-105"
            >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium whitespace-nowrap transition-all ${
                  filter === option.value
                    ...
                    : "bg-slate-800/50 text-slate-400 hover:bg-slate-800 hover:text-white border border-blue-500/20"
                }`}
              >
                {option.label}
              </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-slate-400 mb-6">Be the first to share something with your organization!</p>
            <button
              onClick={() => setShowCreateModal(true)}
